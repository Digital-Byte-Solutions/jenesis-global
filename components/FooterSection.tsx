...
export default function FooterSection() {
  ...
  return (
    <footer id="contact" className="relative z-20 w-full min-h-screen flex flex-col justify-end px-6 md:px-16 pb-12 pointer-events-auto">
      <div className="max-w-6xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-end mb-16 bg-black/75 border border-[#ff1744]/40 p-8 md:p-12 rounded-3xl backdrop-blur-xl shadow-[0_0_60px_rgba(255,23,68,0.25)]">
        {/* Left Column: Heading & Global Locations */}
        <div>
          <div className="text-xs font-mono text-[#ff4d8d] tracking-widest uppercase mb-3 font-bold flex items-center gap-2">
          ...
          <h2 className="text-3xl md:text-5xl font-extrabold font-mono text-white tracking-tight leading-tight mb-6">
            READY TO ARCHITECT YOUR <span className="text-[#ff1744]">NEXT ERA?</span>
          </h2>
          ...
          <div className="grid grid-cols-3 gap-4 border-t border-white/10 pt-6 text-xs font-mono">
            <div>
              <div className="text-[#ff1744] font-bold">SAN FRANCISCO</div>
              <div className="text-gray-400 text-[10px] mt-1">Silicon Valley HQ</div>
            </div>
            <div>
              <div className="text-[#ff1744] font-bold">LONDON</div>
              <div className="text-gray-400 text-[10px] mt-1">European Hub</div>
            </div>
            <div>
              <div className="text-[#ff1744] font-bold">TOKYO</div>
        ...
        <div>
          {submitted ? (
            <div className="p-8 rounded-2xl bg-[#ff1744]/15 border border-[#ff1744] text-center flex flex-col items-center gap-4">
              <CheckCircle2 size={48} className="text-[#ff1744]" />
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-black/60 border border-white/15 focus:border-[#ff1744] text-white text-sm font-mono placeholder:text-gray-600 focus:outline-none transition-colors"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-black/60 border border-white/15 focus:border-[#ff1744] text-white text-sm font-mono placeholder:text-gray-600 focus:outline-none transition-colors resize-none"
                />
              </div>
              ...
              <button
                ...
                className="w-full py-4 rounded-xl bg-[#ff1744] hover:bg-white text-white hover:text-black font-mono font-bold text-xs tracking-widest flex items-center justify-center gap-2 transition-all duration-300 shadow-[0_0_30px_rgba(255,23,68,0.5)]"
              >
      ...
      <div className="max-w-6xl mx-auto w-full flex flex-col sm:flex-row justify-between items-center text-[10px] font-mono text-gray-500 border-t border-white/10 pt-6">
        ...
        <div className="flex gap-6 mt-3 sm:mt-0">
          <a href="#privacy" className="hover:text-[#ff1744] transition-colors">
            PRIVACY PROTOCOL
          </a>
          <a href="#terms" className="hover:text-[#ff1744] transition-colors">
            TERMS OF SERVICE
          </a>
          <a href="#security" className="hover:text-[#ff1744] transition-colors">
